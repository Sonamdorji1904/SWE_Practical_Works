...
class BinarySearchTree:
    ...
    def _count_nodes_recursive(self, node):
        if node is None:
            return 0  # Base case: if the node is None, count is 0
    ...
    def _height_recursive(self, node):
        ...
        # Height of the current node is 1 plus the max height of the left and right subtrees
...
print("Total number of nodes in BST:", bst.count_nodes())  # Output: 7
